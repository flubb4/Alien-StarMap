...
const _SHOP_CATALOG = {
  ...
  specials: [
    { id:'rebuiltm41',icon:'pulserifle',name:'"REBUILT" M41A PULSE RIFLE',
      desc:'Modifier +2, Damage 2, AP, Full Auto, Range S/L, Ammo 3, grenade launcher. ⚠ Unreliable — Gustav\'s own machine-shop mods. Jams on Mess-Up (7+). 40% off retail. Good news first: it shoots.',
      price: 3200 },
    ...
    { id:'foldedapesuit',icon:'apesuit',name:'FOLDED W-Y APESUIT (DAMAGED)',
      desc:'Armor 1, Air 4. ⚠ Acid resistance reduced to Armor 1 (factory is 3). Facehugger protection INTACT. There\'s a hole at the knee. Nothing came through it. Probably. Half-price.',
      price: 4200 },
    ...
    { id:'uppknife', icon:'knife',      name:'CARBON-SCORED UPP COMBAT KNIFE',
      desc:'Modifier +1, Damage 2, Range A/A. Standard knife stats. Engraved in Cyrillic: "За отца." Gustav won\'t say where he got it. The hilt is still discoloured.',
      price: 120 },
    ...
    { id:'usedcryo', icon:'cryopod',    name:'USED MK.III CIVILIAN CRYO-POD',
      desc:'Single-occupant hypersleep capsule. Functional. Some old brown stains around the drain. The vendor declines all questions regarding the previous occupant. Asking again costs $100.',
      price: 12000 },
